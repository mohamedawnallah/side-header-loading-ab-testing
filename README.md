...
| 3 | ❌                     | ❌                            | Removing Tail Header from both tores                                | Not updating chain tip to the header before | Error creating Error creating chain service: target height not found in index                                                           | Accepted                     |

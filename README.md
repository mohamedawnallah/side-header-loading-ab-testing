...
| 3 | ❌                     | ❌                            | Removing Tail Header from both stores                                | Not updating chain tip for both btc and filter header | Error creating Error creating chain service: target height not found in index                                                           | Accepted                     |
